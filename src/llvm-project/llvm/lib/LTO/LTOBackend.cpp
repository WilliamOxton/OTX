...
static void runOldPMPasses(Config &Conf, Module &Mod, TargetMachine *TM,
  ...
  //ATSGX
  PMB.ATSGX = Conf.ATSGX;
  PMB.ATSGXDebug = Conf.ATSGXDebug;
  PMB.leakageInfo = Conf.leakageInfoFilePath;
  PMB.ATSGXOpt = Conf.ATSGXOpt;
...
Error lto::backend(Config &C, AddStreamFn AddStream,
  ...
  TM->Options.MCOptions.ATSGX = C.ATSGX;
  TM->Options.MCOptions.ATSGXDebug = C.ATSGXDebug;
  TM->Options.MCOptions.ATSGXOpt = C.ATSGXOpt;
